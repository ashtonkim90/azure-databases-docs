...
[!INCLUDE [parameters-azure-notes-azure-storage-blob-block-size-mb](./parameters-azure-notes-azure-storage-blob-block-size-mb.md)]
...
| Allowed values | `on,off` |
| Parameter type | dynamic |
| Documentation | [pg_stat_statements.track_planning](https://www.postgresql.org/docs/15/pgstatstatements.html) |
